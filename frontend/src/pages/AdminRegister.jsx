...
import { ShieldCheck, User, Mail, Lock, Loader2, Key, AlertTriangle } from 'lucide-react';
    ...
    <PublicMotionShell showNavbar={false}>
      <main className="flex min-h-screen items-center justify-center px-6 py-10">
        ...
        >
          ...
          <h1 className="text-center text-4xl font-extrabold tracking-tight text-white">Admin Register</h1>
          <p className="mt-2 text-center text-sm text-zinc-100">
            Create your admin account to manage your smart home system.
          </p>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            >
              {isLoading ? <Loader2 size={18} className="animate-spin" /> : 'Create Admin Account'}
            </button>
          </form>

          <div className="mt-6 text-center text-sm text-zinc-200">
            Already have an account?{' '}
            <Link to="/auth/admin/login" className="font-semibold text-sky-200 hover:text-sky-100">
              Sign In as Admin
            </Link>
          </div>
